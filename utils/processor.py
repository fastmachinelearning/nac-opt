...
def evaluate_braggnn(model, train_loader, val_loader, test_loader, device, num_epochs=50, lr=0.0015, weight_decay=2.2e-9):
    """Evaluates BraggNN models by training and computing performance metrics"""
    ...
    # Print results
    # print(
    #     f"Validation Mean Distance: {val_mean_dist:.4f}, "
    #     f"Test Mean Distance: {test_mean_dist:.4f}, "
