...
Usage (Single-node):
    ...
    python run_global_search.py --config t3_config.yaml
...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str,
                        default=os.path.join(os.environ.get("SCRATCH", ""), "qubit_data") if os.environ.get("SCRATCH") else str(Path(__file__).resolve().parent.parent.parent / "data" / "qubit"),
    ...
    parser.add_argument('--search_space_path', type=str,
                        default=str(Path(__file__).resolve().parent / 'qubit_search_space.yaml'),
